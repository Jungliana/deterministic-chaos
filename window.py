...
class Window:
    def __init__(self, plot):
        self.plot = plot
        self.root = tk.Tk()
        self.label = tk.Label(self.root, text="Chaos deterministyczny")
        ...
        self.button = tk.Button(self.root, text="Lecimyyy")
    ...
    def add_options_to_list(self):
        self.listbox.insert(1, "sinus x")
        self.listbox.insert(2, "tangens x")
        self.listbox.insert(3, "jakies wahadlo")
        self.listbox.insert(4, "bifurkacja")
